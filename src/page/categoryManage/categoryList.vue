  ...
  <div class="contain">
    <div class="input_modal">
      ...
      <div class="input-item">
        ...
        ></el-input>
        <!-- <el-select v-model="nameLike" placeholder="-请选择-" @change="getSubjectList">
          <el-option
    ...
    <!-- 添加题库 -->
    <div class="itemBanck">
      <el-dialog title="新增类别" :visible.sync="itemBank" width="30%" :before-close="handleClose">
  ...
  methods: {
    ...
    submitItemBank() {
      ...
      if(this.itemBankType=='add'){
           let url = CONSTANT.URL.Category.AddCategory
            let param = {
         ...
         let url = CONSTANT.URL.Category.EditICategory;
            let param = {
                id:this.itemBankId,
                name: this.itemBankValue
            };
    ...
    // 列表
    getSubjectList() {
      let url = CONSTANT.URL.Category.ListCategoryPage;
      let data = {
        pageIndex: this.pageIndex,
        pageSize: this.pageSize
      };
      if (this.contentLike != "") {
        data.contentLike = this.contentLike;
      }
      if (this.nameLike != "") {
    ...
    linkToDetail(id) {
      let url = CONSTANT.URL.Category.DetailCategory;
      let param = {
        id: id
      };
      common.requestAjax(url, param, null, res => {
    ...
    deleteItem(id) {
      this.$confirm("确定删除?", "提示", {
        ...
        .then(() => {
          let url = CONSTANT.URL.Category.DeleteCategory;
          let param = { id: id };
          common.requestAjax(url, param, null, res => {
            if (res.code == 200) {
              this.$message({
    ...
    deleteSubject() {
      ...
      let url = CONSTANT.URL.Category.DeletesCategory;
      let dataForm = {
        ids: this.ids
      };
      let param = {};
